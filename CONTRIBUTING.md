...
export GOOGLE_APPLICATION_CREDENTIALS="***"  # the service account must have the following IAM roles: Editor, Kubernetes Engine Cluster Admin, Storage Admin, Storage Object Admin
