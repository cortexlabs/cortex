...
class Client:
    ...
    def deploy(
        ...
        Args:
            api_spec: A dictionary defining a single Cortex API. See https://docs.cortex.dev/v/0.37/ for schema.
    ...
    def deploy_from_file(
        ...
        Args:
            config_file: Local path to a yaml file defining Cortex API(s). See https://docs.cortex.dev/v/0.37/ for schema.
            force: Override any in-progress api updates.
            wait: Block until the API is ready.
