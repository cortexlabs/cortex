...
export CORTEX_IMAGE_MODEL_DOWNLOAD="${CORTEX_IMAGE_MODEL_DOWNLOAD:-cortexlabs/model-download:$CORTEX_VERSION_STABLE}"
...
function install_cortex() {
  ...
  docker run -it --entrypoint /root/install_cortex.sh \
    ...
    -e CORTEX_IMAGE_MODEL_DOWNLOAD=$CORTEX_IMAGE_MODEL_DOWNLOAD \
