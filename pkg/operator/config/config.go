...
type CortexConfig struct {
	...
	PytorchImage      string `json:"pytorch_image"`
	PytorchImageGPU   string `json:"pytorch_gpu_image"`
...
func Init() error {
	Cortex = &CortexConfig{
		...
		PytorchImage:      getStr("IMAGE_PYTORCH"),
		PytorchImageGPU:   getStr("IMAGE_PYTORCH_GPU"),
