...
func TestAvg(t *testing.T) {
    floatNilPtr := (*float64)(nil)
    //intNilPtr := (*int)(nil)
    require.Equal(t, floatNilPtr, Avg([]*float64{}, []*float64{}))

	require.Equal(t, pointer.Float64(1), Avg([]*float64{pointer.Float64(1)}, []*float64{pointer.Float64(10)}))
    require.Equal(t, pointer.Float64(10), Avg([]*float64{pointer.Float64(10)}, []*float64{pointer.Float64(1)}))

    require.Equal(t, pointer.Float64(2), Avg([]*float64{pointer.Float64(1), pointer.Float64(4)}, []*float64{pointer.Float64(2), pointer.Float64(1)}))
}