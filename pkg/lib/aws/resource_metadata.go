...
var EBSMetadatas = map[string]map[string]EBSMetadata{
	...
	"us-gov-east-1": {
		...
		"gp3": {Region: "us-gov-east-1", Type: "gp3", PriceGB: 0.096, PriceIOPS: 0, IOPSConfigurable: false},
	...
	"us-gov-west-1": {
		...
		"gp3": {Region: "us-gov-west-1", Type: "gp3", PriceGB: 0.096, PriceIOPS: 0, IOPSConfigurable: false},
