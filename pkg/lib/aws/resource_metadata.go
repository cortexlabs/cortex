...
var EBSMetadatas = map[string]map[string]EBSMetadata{
	"af-south-1": {
		...
		"sc1": {Region: "af-south-1", Type: "sc1", PriceGB: 0.03332, PriceIOPS: 0, IOPSConfigurable: false},
	...
	"eu-south-1": {
		...
		"sc1": {Region: "eu-south-1", Type: "sc1", PriceGB: 0.0294, PriceIOPS: 0, IOPSConfigurable: false},
	...
	"us-west-1": {
		...
		"sc1": {Region: "us-west-1", Type: "sc1", PriceGB: 0.03, PriceIOPS: 0, IOPSConfigurable: false},
