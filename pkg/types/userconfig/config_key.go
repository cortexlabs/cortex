...
const (
	...
	MaxQueueLengthAnnotationKey               = "autoscaling.cortex.dev/max-replica-queue-length"
	MaxConcurrencyAnnotationKey               = "autoscaling.cortex.dev/max-replica-concurrency"
	TargetInFlightAnnotationKey               = "autoscaling.cortex.dev/target-replica-concurrency"
