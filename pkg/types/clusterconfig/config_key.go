...
const (
	...
	ImagePrometheusKubeStateMetricsExporterKey = "image_prometheus_kube_state_metrics_exporter"
	...
	ImagePrometheusKubeStateMetricsExporterUserKey = "prometheus kube-state-metrics exporter image"
