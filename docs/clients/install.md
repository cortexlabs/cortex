...
To install or upgrade to a specific version (e.g. v0.36.0):

```bash
pip install cortex==0.36.0
```
...
bash -c "$(curl -sS https://raw.githubusercontent.com/cortexlabs/cortex/v0.36.0/get-cli.sh)"
```
