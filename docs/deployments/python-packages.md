...
Note that some packages are pre-installed by default (see "pre-installed packages" for your Predictor type in the [Realtime API Predictor documentation](realtimeapi/predictors.md) and [Batch API Predictor documentation](batchapi/predictors.md)).
