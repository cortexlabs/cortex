...
* Python Predictor (CPU): `quay.io/cortexlabs/python-predictor-cpu-slim:0.23.0`
* Python Predictor (GPU): choose one of the following:
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda10.0-cudnn7`
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda10.1-cudnn7`
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda10.1-cudnn8`
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda10.2-cudnn7`
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda10.2-cudnn8`
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda11.0-cudnn8`
  * `quay.io/cortexlabs/python-predictor-gpu-slim:0.23.0-cuda11.1-cudnn8`
* Python Predictor (Inferentia): `quay.io/cortexlabs/python-predictor-inf-slim:0.23.0`
* TensorFlow Predictor (CPU, GPU, Inferentia): `quay.io/cortexlabs/tensorflow-predictor-slim:0.23.0`
* ONNX Predictor (CPU): `quay.io/cortexlabs/onnx-predictor-cpu-slim:0.23.0`
* ONNX Predictor (GPU): `quay.io/cortexlabs/onnx-predictor-gpu-slim:0.23.0`
...
FROM quay.io/cortexlabs/python-predictor-cpu-slim:0.23.0
