...
* Python Predictor (CPU): `cortexlabs/python-predictor-cpu-slim:0.21.0`
* Python Predictor (GPU): `cortexlabs/python-predictor-gpu-slim:0.21.0-cuda10.1` (also available in cuda10.0, cuda10.2, and cuda11.0)
* Python Predictor (Inferentia): `cortexlabs/python-predictor-inf-slim:0.21.0`
* TensorFlow Predictor (CPU, GPU, Inferentia): `cortexlabs/tensorflow-predictor-slim:0.21.0`
* ONNX Predictor (CPU): `cortexlabs/onnx-predictor-cpu-slim:0.21.0`
* ONNX Predictor (GPU): `cortexlabs/onnx-predictor-gpu-slim:0.21.0`
...
FROM cortexlabs/python-predictor-cpu-slim:0.21.0
