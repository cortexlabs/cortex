...
* Deploy another one of our [batch examples](https://github.com/cortexlabs/cortex/tree/0.22/examples/batch).
* See our [exporting guide](../../guides/exporting.md) for how to export your model to use in an API.
* Try the [realtime API tutorial](../realtime-api/text-generator.md) to learn how to deploy realtime APIs in Cortex.
