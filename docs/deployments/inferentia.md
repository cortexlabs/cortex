...
1. [ResNet50 in TensorFlow](https://github.com/cortexlabs/cortex/tree/0.23/examples/tensorflow/image-classifier-resnet50)
1. [ResNet50 in PyTorch](https://github.com/cortexlabs/cortex/tree/0.23/examples/pytorch/image-classifier-resnet50)
