...
Many of the [examples](https://github.com/cortexlabs/cortex/tree/0.19/examples) use the Python Predictor, including all of the PyTorch examples.

<!-- CORTEX_VERSION_MINOR -->
Here is the Predictor for [examples/pytorch/text-generator](https://github.com/cortexlabs/cortex/tree/0.19/examples/pytorch/text-generator):
...
<!-- CORTEX_VERSION_MINOR -->
Most of the examples in [examples/tensorflow](https://github.com/cortexlabs/cortex/tree/0.19/examples/tensorflow) use the TensorFlow Predictor.

<!-- CORTEX_VERSION_MINOR -->
Here is the Predictor for [examples/tensorflow/iris-classifier](https://github.com/cortexlabs/cortex/tree/0.19/examples/tensorflow/iris-classifier):
...
<!-- CORTEX_VERSION_MINOR -->
[examples/onnx/iris-classifier](https://github.com/cortexlabs/cortex/tree/0.19/examples/onnx/iris-classifier) uses the ONNX Predictor:
