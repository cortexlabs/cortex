...
predictor:
  ...
  image: <string> # docker image to use for the Predictor (default: quay.io/cortexlabs/python-handler-cpu:master or quay.io/cortexlabs/python-handler-gpu:master-cuda10.2-cudnn8 based on compute)
