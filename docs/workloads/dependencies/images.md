...
* Python Predictor (CPU): `quay.io/cortexlabs/python-predictor-cpu:0.33.0`
...
* Python Predictor (Inferentia): `quay.io/cortexlabs/python-predictor-inf:0.33.0`
* TensorFlow Predictor (CPU, GPU, Inferentia): `quay.io/cortexlabs/tensorflow-predictor:0.33.0`
...
FROM quay.io/cortexlabs/python-predictor-cpu:0.33.0
