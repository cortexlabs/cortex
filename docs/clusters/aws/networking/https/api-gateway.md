...
# Setting up HTTP with API Gateway

There may be situations where you need to use AWS's "REST" API Gateway, e.g. to enforce IAM-based auth. 
This guide covers setting up HTTPS with AWS's "REST" API Gateway.
