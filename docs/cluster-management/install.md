...
_Note: you must also have [Docker](https://docs.docker.com/install) installed to run Cortex locally or on AWS._

If you are planning to only run Cortex locally, skip to [deploy an example](#deploy-an-example) below.
...
# set the default CLI environment
