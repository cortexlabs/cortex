...
Cortex makes all files in the project directory (i.e. the directory which contains `cortex.yaml`) available to request handlers. `cortex.yaml`, Python generated files, and files or folders that start with `.` are excluded.
