...
from workers import BroadcastReassembled, InferenceWorker, Flusher
...
def main():
    ...
    reassembler = BroadcastReassembled(inferenced_queue, serve_address=("", 8000), name="BroadcastReassembled")
    reassembler.start()
