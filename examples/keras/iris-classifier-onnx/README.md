...
- kind: api
  name: classifier
  onnx:
    model: s3://cortex-examples/keras/iris-classifier-onnx/nn.onnx
...
- [Keras](https://colab.research.google.com/github/cortexlabs/cortex/blob/master/examples/keras/iris-classifier-onnx/keras.ipynb)
