...
- kind: api
  name: classifier
  onnx:
    model: s3://cortex-examples/sklearn/iris-classifier-onnx/logreg.onnx
...
- [sklearn](https://colab.research.google.com/github/cortexlabs/cortex/blob/master/examples/sklearn/iris-classifier-onnx/sklearn.ipynb)
