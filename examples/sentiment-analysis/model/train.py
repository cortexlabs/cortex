...
Original file is located at
    https://colab.research.google.com/github/cortexlabs/cortex/blob/sentiment-notebook/examples/sentiment-analysis/model/train.ipynb
"""
...
"""Below, we'll set an output location to store our model output, checkpoints, and export in a local directory. Note: local directories don't persist after the Colab session ends."""
...
First, we'll install the AWS CLI (don't forget to reload your runtime after installation is complete):
"""

!pip install awscli

"""Set these environment variables to configure the AWS CLI and upload path:"""

AWS_ACCESS_KEY_ID = "" #@param {type:"string"}
AWS_SECRET_ACCESS_KEY = "" #@param {type:"string"}
S3_UPLOAD_PATH = "s3://my-bucket/bert" #@param {type:"string"}

import os
os.environ['AWS_ACCESS_KEY_ID'] = AWS_ACCESS_KEY_ID
os.environ['AWS_SECRET_ACCESS_KEY'] = AWS_SECRET_ACCESS_KEY
os.environ['S3_UPLOAD_PATH'] = S3_UPLOAD_PATH

"""Upload to S3:"""

!aws s3 sync ./bert/export "$S3_UPLOAD_PATH"
