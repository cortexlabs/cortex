...
ci-build-images:
	@./build/build-image.sh --include-slim images/python-predictor-cpu python-predictor-cpu
	@./build/build-image.sh --include-slim images/python-predictor-gpu python-predictor-gpu
	...
	@./build/build-image.sh --include-slim images/tensorflow-predictor tensorflow-predictor
	@./build/build-image.sh --include-slim images/onnx-predictor-cpu onnx-predictor-cpu
	@./build/build-image.sh --include-slim images/onnx-predictor-gpu onnx-predictor-gpu
...
ci-push-images:
	@./build/push-image.sh --include-slim python-predictor-cpu
	@./build/push-image.sh --include-slim python-predictor-gpu
	@./build/push-image.sh tensorflow-serving-cpu
	@./build/push-image.sh tensorflow-serving-gpu
	@./build/push-image.sh --include-slim tensorflow-predictor
	@./build/push-image.sh --include-slim onnx-predictor-cpu
	@./build/push-image.sh --include-slim onnx-predictor-gpu
