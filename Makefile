...
ci-build-images:
	...
	@./build/build-image.sh images/python-serve-inf python-serve-inf
	@./build/build-image.sh images/python-serve-gpu python-serve-gpu
	@./build/build-image.sh images/tf-serve tf-serve
	@./build/build-image.sh images/tf-serve-inf tf-serve-inf
...
ci-push-images:
	...
	@./build/push-image.sh python-serve-inf
	@./build/push-image.sh python-serve-gpu
	@./build/push-image.sh tf-serve
	@./build/push-image.sh tf-serve-inf
